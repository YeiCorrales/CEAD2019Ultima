...
$bloque2 = <<<EOF
   ...
   <table>
        <tr>
            <td>Periodo Academico: $name</td>
        </tr>
    </table><br>
    <h2>Matricula Global</h2><br>
...
//----SALIDA DEL PDF
$pdf->Output('matriculaglobal.pdf', 'I');
